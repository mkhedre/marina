...
import img from '@/public/Images/categories/paul-postema-VoEocAfaWG8-unsplash.jpg';
const cols = [
  {
...
const Index = ({ data }) => {
  return (
    <PageComponent styles={styles} title="RENTALS" hero={img.src}>
      <div
