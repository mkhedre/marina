...
import img from '@/public/Images/categories/luis-vidal-SDEb1se-lLA-unsplash.jpg';
const cols = [
  {
...
const Index = ({ data }) => {
  return (
    <PageComponent styles={styles} title="WATER ACTIVITIES" hero={img.src}>
      <div
