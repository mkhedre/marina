...
import img from '@/public/Images/categories/reisetopia-aI6Su7Mu9Ro-unsplash.jpg';
const cols = [
  {
...
const Index = ({ data }) => {
  return (
    <PageComponent styles={styles} title="HOTELS" hero={img.src}>
      <divid
